...
LOCATIONS: dict[str, Location] = {
    ...
    # Province-level locations (added for 2020-2026 provincial setting)
    "capitol":    Location("capitol",    "Provincial Capitol","government",   80, .20, .08, .14, .10),
    "prv_hosp":   Location("prv_hosp",   "Prov. Hospital",    "civic",        100, .36, .08, .10, .10),
    "ecozone":    Location("ecozone",    "Ecozone / PEZA",    "industrial",   180, .68, .08, .18, .13),
    "mall":       Location("mall",       "SM Mall",           "commercial",   250, .22, .20, .12, .10),
    "court":      Location("court",      "Regional Court",    "government",   20,  .70, .42, .07, .06),
    "subdivision":Location("subdivision","Subdivision",       "residential",  350, .76, .24, .13, .16),
}
